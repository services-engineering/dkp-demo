...
try {
    cassandraClient = new cassandra.Client({ contactPoints: ['cassandra-node-0.cassandra-svc.default.svc.cluster.local:9042'], keyspace: 'trucks', localDataCenter: 'datacenter1' });
