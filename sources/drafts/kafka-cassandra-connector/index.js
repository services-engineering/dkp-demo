...
const kafkaClient = new kafka.KafkaClient({ kafkaHost: 'kafka-kafka-0.kafka-svc.truck-demo.svc.cluster.local:9093' })
...
try {
    cassandraClient = new cassandra.Client({ contactPoints: ['cassandra-node-0.cassandra-svc.truck-demo.svc.cluster.local:9042'], keyspace: 'trucks', localDataCenter: 'datacenter1' });
